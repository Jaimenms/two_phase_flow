...
from methods.fdm.schemes.upwind.upwind_scheme_n1_fdm_weights import UpwindSchemeN1FDMWeights
...
from methods.fdm.schemes.downwind.downwind_scheme_n1_fdm_weights import DownwindSchemeN1FDMWeights
...
class FDMEnum(Enum):
    ...
    UPWIND_N1 = (1, UpwindSchemeN1FDMWeights())
    ...
    DOWNWIND_N1 = (1, DownwindSchemeN1FDMWeights())
